...
Задание 2.1:
  ...
  -> На стороне УТГГ добавлен журнал регистрации архива, где показывают вариант запуска синхронизации, время, номера пакетов отправки и получении, количество объектов регистрации на этом пакете и текст ошибки.
